---
name: extract-rainbow-springs-reservation
description: Extract Florida State Parks day-use vehicle entry reservations from screenshots and copy as CSV. Use when user provides Payment Summary screenshots from reserve.floridastateparks.org or asks to extract park reservations.
---
...
Destination sheet: <https://docs.google.com/spreadsheets/d/1wLHPw0uB7pe7hw_NJ9hPQWoQ2mt4uyv7_2YaQUt8-UU/edit?gid=0#gid=0>

See `reservations.js` in this skill folder for the Apps Script that runs on the destination sheet.
Copy-paste into **Extensions → Apps Script** in the Reservations sheet. No clasp, no deploy.
